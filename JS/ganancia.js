...
let flujoCaja1 = datos.map(datos => {
    let flujoCaja2 = (datos.ingresos - datos.gastos);
    if (flujoCaja2 > 0) {
        flujoCaja2 = 1;
        document.writeln(`<br/> Mes: ${datos.mes} 
        Estado del flujo de caja: ${flujoCaja2} `);
    }
    else if (flujoCaja2 < 0) {
        flujoCaja2 = -1;
        document.writeln(`<br/> Mes: ${datos.mes} 
        Estado del flujo de caja: ${flujoCaja2} `);
    }
